...
namespace UnitySharpNEAT
{
    ...
    public class NeatSupervisor : MonoBehaviour
    {
        ...
        [SerializeField]
        public int _networkInputCount = 3;

        [SerializeField]
        public int _networkOutputCount = 2;
        ...
        public UnitController _unitControllerPrefab = default;
        ...
        private void Start()
        {
            ...
            //GameObject charac = Resources.Load("Character") as GameObject;
            GameObject charac = GameObject.FindGameObjectWithTag("mainBody");
           
            _unitControllerPrefab = charac.GetComponent<LegMove>();

            _networkOutputCount = (charac.GetComponent<mainBodyInfo>().legList.Count-1)*2+1;
